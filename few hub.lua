...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Autsadawut Hub BF Premium') then
        makefolder('Autsadawut Hub BF Premium')
    end
    if not _G.Dis and not isfile('Autsadawut Hub BF Premium/'..Name..'.json') then
        writefile('Autsadawut Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Autsadawut Hub BF Premium') and isfile('Autsadawut Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Autsadawut Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("field",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
